...
const routes: Routes = [
  ...
  {path:'buscar-cursos', component:BuscarCursosPage, data: {title: 'Buscar Cursos',expectedRoles: ['estudiante', 'docente']},canActivate: [AuthService]},
  ...
  {path:'editar_curso/:id', component: Editar_curso, data: { title: 'Editar Curso',expectedRole: 'docente'}, canActivate: [AuthService] },
  ...
  {path: 'settings-page', component: SettingsPageV1, data: {title:'Editar Perfil',expectedRoles: ['estudiante', 'docente']},canActivate: [AuthService]},
